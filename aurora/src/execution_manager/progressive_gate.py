...
def em_pgr_flag_snapshot() -> dict[str, Any]:
    ...
    effective = get_effective_em_activation_pct()
    # Lazy import avoids flags ↔ progressive_gate cycle at module load.
    from src.execution_manager.flags import assess_em_mirror_drift
    ...
    return {
        ...
        # Live probe (Mission 047) — do not hardcode OPEN after mirror sync.
        "mirror_drift_open": assess_em_mirror_drift()["mirror_drift_open"],
        "gates": gates,
