...
# ---------------------------------------------------------------------------
# Higher pct / PGR-06 locked / independent prior gates
# ---------------------------------------------------------------------------
...
def test_pgr06_enable_does_not_auto_advance_from_pgr01():
    """PGR-06 enable with pct=1 stays at 1% (no auto-advance to 100%)."""
    _clear_em_flags()
    _arm_pgr01()
