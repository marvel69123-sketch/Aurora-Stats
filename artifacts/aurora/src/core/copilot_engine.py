...
# ---------------------------------------------------------------------------
# Phase 5A — aliases + normalize live in EntityResolver (SoT).
# Keep public names for backward compatibility; do not duplicate the table.
from src.core.team_aliases import TEAM_ALIASES as _TEAM_ALIASES
from src.core.entity_resolver import (
    alias_keys as _alias_keys,
    normalize_team_name as _er_normalize_team_name,
)


def normalize_team_name(name: str) -> str:
    """Compat wrapper → EntityResolver.normalize_team_name (Phase 5A)."""
    return _er_normalize_team_name(name)
