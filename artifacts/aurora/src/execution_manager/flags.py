...
def em_flag_snapshot() -> dict[str, Any]:
    ...
    return {
        ...
        # Phase 5 Progressive Activation — PGR-01..PGR-04 capability; defaults OFF.
        ...
        "phase5_pgr05_not_started": True,
        "phase5_authorized_highest_gate": "PGR-04",
        "phase5_authorized_max_pct": 25,
