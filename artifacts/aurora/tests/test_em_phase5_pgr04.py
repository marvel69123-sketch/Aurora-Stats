...
# ---------------------------------------------------------------------------
# Higher pct / PGR-06 locked / PGR-01..PGR-03 still available
# ---------------------------------------------------------------------------


def test_pgr04_pct50_without_pgr05_fail_closed():
    """pct=50 with only PGR-04 stays OFF (independent PGR-05 gate)."""
    _clear_em_flags()
    os.environ["ENABLE_EM_PGR_04"] = "1"
...
def test_pgr06_enable_does_not_auto_advance_from_pgr04():
    """PGR-06 enable with pct=25 stays at 25% (no auto-advance to 100%)."""
    _clear_em_flags()
    _arm_pgr04()
