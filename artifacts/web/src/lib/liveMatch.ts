...
const ALIAS_GROUPS: string[][] = [
  ...
  ["hercilio luz", "hercílio luz", "hercilio luz fc"],
  ["juventus sc", "juventus jaragua", "juventus de jaragua"],
  ["barcelona sc", "barcelona sporting club", "barcelona guayaquil"],
  ["guayaquil city", "guayaquil city fc"],
  ["universidad catolica del ecuador", "catolica", "católica", "u catolica ecuador"],
  ["one knoxville", "one knoxville sc", "knoxville"],
